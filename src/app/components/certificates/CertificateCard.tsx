    ...
    >
      ...
      <div className="relative h-48 w-full overflow-hidden">
        ...
        {certificate.hours && (
          <div className="absolute top-3 right-3 bg-red-600/90 backdrop-blur-sm px-3 py-1 rounded-full flex items-center gap-1">
            ...
            <span className="text-xs font-semibold text-white">{certificate.hours}</span>
          </div>
        )}
      </div>
      ...
      <div className="p-5">
        <div className="flex items-start justify-between mb-2">
          ...
          <ExternalLink size={18} className="text-gray-400 group-hover:text-red-500 transition-colors flex-shrink-0 ml-2" />
        </div>
